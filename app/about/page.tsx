...
export default function AboutPage() {
  return (
    <div className="flex flex-col min-h-screen bg-[var(--paper)]">
      ...
      <div className="layout-container grid grid-cols-1 md:grid-cols-2 divide-x divide-[var(--ink)] border-b border-[var(--ink)] bg-white/20">
        <div className="p-16 space-y-8">
          <div className="flex h-12 w-12 items-center justify-center bg-[var(--ink)] text-[var(--paper)] font-bold text-xl [clip-path:polygon(0%_0%,100%_5%,95%_100%,5%_95%)]">
            M
          </div>
          <h3 className="text-3xl font-bold uppercase underline decoration-[var(--ink)]/20 underline-offset-8">The Mission</h3>
        ...
        <div className="p-16 space-y-8 bg-[var(--paper-dark)]/30">
          <div className="flex h-12 w-12 items-center justify-center bg-[var(--ink)] text-[var(--paper)] font-bold text-xl [clip-path:polygon(5%_5%,95%_0%,100%_95%,0%_100%)]">
            P
          </div>
          <h3 className="text-3xl font-bold uppercase underline decoration-[var(--ink)]/20 underline-offset-8">MCP-First</h3>
          <p className="text-xl font-serif italic text-[var(--ink-fade)] leading-relaxed">
      ...
      <section className="py-24">
        <div className="layout-container">
          <div className="max-w-3xl">
            ...
            <p className="text-xl font-serif italic text-[var(--ink-fade)] mb-12 leading-relaxed">
