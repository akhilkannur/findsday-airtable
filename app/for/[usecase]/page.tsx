  ...
  return (
    <div className="flex flex-col min-h-screen bg-paper">
      ...
      <section className="py-12 md:py-20">
        <div className="layout-container">
          {tools.length < 3 && (
            <div className="mb-8 md:mb-12 p-6 md:p-8 border border-dashed border-ink/30 bg-white/40">
              <p className="text-base md:text-lg text-ink-fade">
                We&apos;re still building out this category.{" "}
                <Link
                  href="/submit"
                  className="underline hover:text-ink-fade transition-colors"
                >
                  Submit a tool
                </Link>{" "}
      ...
      <section className="py-16 md:py-24 bg-white/40 border-t border-ink">
        <div className="layout-container">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 md:mb-16 gap-6 md:gap-8">
            <h2 className="text-2xl md:text-3xl">Keep Exploring</h2>
            <Link
              href="/api"
              className="font-mono text-[0.7rem] md:text-[0.75rem] uppercase underline transition-colors hover:text-ink-fade"
            >
              Full Directory -&gt;
            </Link>
          </div>
          ...
          <div className="flex flex-wrap gap-4 md:gap-6 pt-8 border-t border-dashed border-ink/20">
            <Link
              href="/api"
              className="font-mono text-[0.75rem] uppercase underline transition-colors hover:text-ink-fade"
            >
              All Tools
            </Link>
            <Link
