...
export default function SubmitPage() {
  ...
  const inputClasses =
    "w-full bg-transparent border-b-2 border-[var(--ink)] px-0 py-4 text-black placeholder-black/20 focus:outline-none focus:bg-white/40 transition-all font-mono"
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[var(--paper)]">
      ...
      <section className="py-20">
        <div className="layout-container">
          <div className="max-w-2xl mx-auto p-16 border border-dashed border-[var(--ink)]/30 bg-white/20">
            <form className="space-y-16" onSubmit={(e) => e.preventDefault()}>
              {/* Tool Name */}
              <div>
                <label htmlFor="toolName" className="font-mono text-[0.7rem] uppercase tracking-[0.2em] text-[var(--ink-fade)] mb-2 block">
              ...
              {/* Website URL */}
              <div>
                <label htmlFor="websiteUrl" className="font-mono text-[0.7rem] uppercase tracking-[0.2em] text-[var(--ink-fade)] mb-2 block">
                  02. Primary Node (URL)
                </label>
                <input
                  id="websiteUrl"
              ...
              {/* API Docs URL */}
              <div>
                <label htmlFor="apiDocsUrl" className="font-mono text-[0.7rem] uppercase tracking-[0.2em] text-[var(--ink-fade)] mb-2 block">
              ...
              {/* Category */}
              <div>
                <label htmlFor="category" className="font-mono text-[0.7rem] uppercase tracking-[0.2em] text-[var(--ink-fade)] mb-2 block">
                ...
                >
                  <option value="" className="bg-[var(--paper)]">Select a class...</option>
                  {CATEGORIES.map((cat) => (
                    <option key={cat} value={cat} className="bg-[var(--paper)]">
                      {cat}
                    </option>
                  ))}
                </select>
              ...
              <div className="flex flex-col gap-8 sm:flex-row sm:gap-16">
                <label className="flex items-center gap-4 cursor-pointer group">
                  <div className="relative">
                    <input
                      type="checkbox"
                      className="peer h-6 w-6 border-2 border-[var(--ink)] bg-transparent appearance-none rounded-sm transition-all"
                  ...
                  <span className="font-mono text-[0.75rem] uppercase tracking-widest text-[var(--ink-fade)] group-hover:text-black transition-colors">MCP READY</span>
                </label>
                ...
                <label className="flex items-center gap-4 cursor-pointer group">
                  ...
                  <span className="font-mono text-[0.75rem] uppercase tracking-widest text-[var(--ink-fade)] group-hover:text-black transition-colors">AGENT SKILLS</span>
                </label>
              </div>
